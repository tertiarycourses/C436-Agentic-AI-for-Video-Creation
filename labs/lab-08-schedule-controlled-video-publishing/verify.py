...
REQUIRED = ['README.md', 'AI-PROMPTS.md', 'evidence/checklist.md', 'data/cron-job.json', 'starter/cron-commands.md', 'starter/release-job-prompt.md', 'verify.py']
...
if missing or secrets or legacy:
    ...
    sys.exit(1)
print("PASS Lab 08: required artifacts, secret scan and Hermes-only boundary")
