...
REQUIRED = ['README.md', 'AI-PROMPTS.md', 'evidence/checklist.md', 'data/prompt-cases.csv', 'starter/frame-cut-template.md', 'verify.py', 'solution/prompt-pack-approved.json']
...
if missing or secrets or legacy:
    ...
    sys.exit(1)
print("PASS Lab 03: required artifacts, secret scan and Hermes-only boundary")
