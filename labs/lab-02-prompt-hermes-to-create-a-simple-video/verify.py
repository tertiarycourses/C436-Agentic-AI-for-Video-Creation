...
REQUIRED = ['README.md', 'AI-PROMPTS.md', 'evidence/checklist.md', 'data/video-brief.json', 'starter/render_preview.py', 'verify.py', 'solution/shot-plan-approved.json']
...
if missing or secrets or legacy:
    ...
    sys.exit(1)
print("PASS Lab 02: required artifacts, secret scan and Hermes-only boundary")
