...
REQUIRED = ['README.md', 'AI-PROMPTS.md', 'evidence/checklist.md', 'data/brand-profile.yaml', 'custom-skill/SKILL.md', 'custom-skill/scripts/render_brand_video.py', 'verify.py', 'solution/custom-video.mp4']
...
if missing or secrets or legacy:
    ...
    sys.exit(1)
print("PASS Lab 05: required artifacts, secret scan and Hermes-only boundary")
