...
REQUIRED = ['README.md', 'AI-PROMPTS.md', 'evidence/checklist.md', 'data/kanban-tasks.csv', 'data/youtube-request-preview.json', 'starter/kanban-commands.md', 'verify.py']
...
if missing or secrets or legacy:
    ...
    sys.exit(1)
print("PASS Lab 07: required artifacts, secret scan and Hermes-only boundary")
