...
REQUIRED = ['README.md', 'AI-PROMPTS.md', 'evidence/checklist.md', 'hermes-config.example.yaml', 'minimax-credential-template.md', 'verify.py', 'data/setup-checklist.csv']
...
if missing or secrets or legacy:
    ...
    sys.exit(1)
print("PASS Lab 01: required artifacts, secret scan and Hermes-only boundary")
