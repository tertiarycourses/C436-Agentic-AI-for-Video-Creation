...
REQUIRED = ['README.md', 'AI-PROMPTS.md', 'evidence/checklist.md', 'data/tool-registry.csv', 'skills/remotion-video/SKILL.md', 'skills/manim-explainer/SKILL.md', 'skills/higgsfield-shot/SKILL.md', 'verify.py']
...
if missing or secrets or legacy:
    ...
    sys.exit(1)
print("PASS Lab 04: required artifacts, secret scan and Hermes-only boundary")
